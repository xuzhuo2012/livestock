 ...
 * @author Hang
 */
public class MedicineRecordFragment extends EntityListViewFragment<MedicineRecord,Date> {
	MyListView listView;
        private AsyncCallback<List<MedicineRecord>> action = new ListCallback();

        /**
         * @author Hang
         */
        private final class ListCallback implements AsyncCallback<List<MedicineRecord>> {
                @Override
                public void call(List<MedicineRecord> result) {
                        if (result == null) {
        ...
        private RemoteProcedureCall<MedicineRecord, Date> call = (RemoteProcedureCall<MedicineRecord, Date>) ObjectConfigedFactory.getRemoteProcedureCallFactory().getBean(MedicineRecord.class);
        ...
        private void buildYearSelectEvent(View view) {
                yearSelect = (Spinner) view.findViewById(R.id.medicine_year_select);
        ...
        private void buildPageButtonEvent(View view) {
                Button next = (Button) view.findViewById(R.id.next_medicine_button);
                ...
                Button pre = (Button) view.findViewById(R.id.pre_medicine_button);
        ...
        private void buildRefreshButtonEvent(View view) {
                Button refresh = (Button) view.findViewById(R.id.medicine_refresh_button);
        ...
        private View buildView(LayoutInflater inflater, ViewGroup container) {
                View view = inflater.inflate(R.layout.medicine_manager_fragment_view, container, false);
                if (this.getAdapter() != null) {
                		listView = (MyListView) view.findViewById(R.id.medicineRecord_listview);
                        if (listView != null) {

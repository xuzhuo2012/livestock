 ...
 * @author Hang
 */
public class AntiepidemicFragment extends EntityListViewFragment<Antiepidemic, AntiepidemicId> {
	MyListView listView;
        private AsyncCallback<List<Antiepidemic>> action = new ListCallback();

        /**
         * @author Hang
         */
        private final class ListCallback implements AsyncCallback<List<Antiepidemic>> {
                @Override
                public void call(List<Antiepidemic> result) {
                        if (result == null) {
        ...
        private RemoteProcedureCall<Antiepidemic, AntiepidemicId> call = (RemoteProcedureCall<Antiepidemic, AntiepidemicId>) ObjectConfigedFactory.getRemoteProcedureCallFactory().getBean(Antiepidemic.class);
        ...
        private void buildYearSelectEvent(View view) {
                yearSelect = (Spinner) view.findViewById(R.id.antiepidemic_year_select);
        ...
        private void buildPageButtonEvent(View view) {
                Button next = (Button) view.findViewById(R.id.next_antiepidemic_button);
                ...
                Button pre = (Button) view.findViewById(R.id.pre_antiepidemic_button);
        ...
        private void buildRefreshButtonEvent(View view) {
                Button refresh = (Button) view.findViewById(R.id.antiepidemic_refresh_button);
        ...
        private View buildView(LayoutInflater inflater, ViewGroup container) {
                View view = inflater.inflate(R.layout.antiepidemic_manager_fragment_view, container, false);
                if (this.getAdapter() != null) {
                        listView = (MyListView) view.findViewById(R.id.antiepidemic_listview);
                        if (listView != null) {
